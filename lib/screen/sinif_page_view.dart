...
class _SinifPageViewState extends State<SinifPageView> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          SinifCubit(databaseProvider: SinifDatabaseProvider()),
  ...
  Widget buildTransaction(
      BuildContext context, SinifModel sinifModel, int index) {
    return SinifCard(
        transaction: sinifModel,
        index: index,
        butons: buildButtons(context, sinifModel));
  }
                ...
                MaterialPageRoute(
                  builder: (_) => SinifDialog(
                    ...
                    onClickedDone: (id, sinifAd) =>
                        editTransaction(context, sinifModel, id, sinifAd),
                  ),
                ),
              ),
            ),
  ...
  editTransaction(
      BuildContext context, SinifModel sinifModel, int? id, String sinifAd) {
    sinifModel.id = id;
    sinifModel.sinifAd = sinifAd;
